...
const EmergencyPage = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-sky-800 text-center p-6">
      <div className="bg-white shadow-lg rounded-2xl p-8 max-w-lg w-full">
        ...
        <div className="mt-6 flex justify-center">
          <button
            ...
            className="bg-red-600 text-white px-6 py-3 rounded-xl text-lg font-semibold hover:bg-sky-600 transition-all"
          >
            🚑 Book Now
          </button>
        </div>
